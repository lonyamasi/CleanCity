...
**Expected vs Actual**
Expected: Error pops up,password must be 8 characters long
Actual:Pop up- Password must be 3 characters.  User is able to proceed with registration,
...
Actual - creates two  different users
...
- Application accepts past dates and even last year for waste pickup scheduling
...
**Objective**
Test that the system does not allow a user to submit multiple pickup requests for the same location and date, ensuring no scheduling conflicts or accidental duplicates
